    <div
        ...
        <div class="mt-3 px-5 pb-5">
            <h3 class="text-primary mb-3 text-center text-xl font-bold tracking-tight text-gray-900 dark:text-white"
                style="font-size:x-large;">
                {{ $product->title }}
            </h3>
            <h5 class="mb-3 text-center text-sm font-bold tracking-tight text-gray-500 dark:text-white"
                style="font-size:x-large;">
                By {{ $product->user->name }}
            </h5>
            <p class="mb-6 text-lg font-normal text-gray-500 dark:text-gray-400">{{ $product->description }}</p>
            {{-- product rating --}}
