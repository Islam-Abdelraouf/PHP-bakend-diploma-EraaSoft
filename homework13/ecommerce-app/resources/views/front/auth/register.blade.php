...
<html lang="en" class="h-full bg-gray-100">
    ...
    <head>
        ...
        <title>Ecommerce App Register</title>
    ...
    <div class="flex h-screen items-center justify-center bg-gray-100">
        ...
        <form class="w-100 max-w-xl rounded border bg-white p-5 shadow-lg" action="{{ route('register.submit') }}"
            method="POST">
            ...
            <div class="mb-6 grid gap-6 p-5 md:grid-cols-1"">
                ...
                <div>
                    ...
                    <input type="text" name="name"
                        ...
                        <x-validation-errors errorName="name"></x-validation-errors>
                </div>
                {{-- email --}}
                <div>
                    <label for="email"
                    ...
                    <input type="email" name="email"
                        ...
                        <x-validation-errors errorName="email"></x-validation-errors>
                </div>
                {{-- password --}}
                <div>
                    <label for="password"
                    ...
                    <input type="password" name="password"
                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" />
                        <x-validation-errors errorName="password"></x-validation-errors>
                </div>
                {{-- Submit Button --}}
                <div class="full-width mb-3">
                    ...
                    <div>
                        <p class="mt-2 text-center font-medium">Already member? <a href="{{ route('auth.login') }}"
                                class="text-blue-600 hover:underline dark:text-blue-500">Login</a></p>
                    </div>
                </div>
            </div>
        </form>
